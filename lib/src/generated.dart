...
class SentcFlutterImpl implements SentcFlutter {
  final SentcFlutterPlatform _platform;
  factory SentcFlutterImpl(ExternalLibrary dylib) =>
      SentcFlutterImpl.raw(SentcFlutterPlatform(dylib));

  /// Only valid on web/WASM platforms.
  factory SentcFlutterImpl.wasm(FutureOr<WasmModule> module) =>
      SentcFlutterImpl(module as ExternalLibrary);
  SentcFlutterImpl.raw(this._platform);
  Future<Claims> decodeJwt({required String jwt, dynamic hint}) {
  ...
  Future<String> prepareCheckUserIdentifierAvailable(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner
          .wire_prepare_check_user_identifier_available(port_, arg0),
  ...
  Future<bool> doneCheckUserIdentifierAvailable(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner
          .wire_done_check_user_identifier_available(port_, arg0),
      parseSuccessData: _wire2api_bool,
  ...
  Future<String> prepareRegisterDeviceStart(
      ...
      required String password,
      dynamic hint}) {
    var arg0 = _platform.api2wire_String(deviceIdentifier);
    var arg1 = _platform.api2wire_String(password);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_prepare_register_device_start(port_, arg0, arg1),
      parseSuccessData: _wire2api_String,
  ...
  Future<PreRegisterDeviceData> prepareRegisterDevice(
      ...
      dynamic hint}) {
    var arg0 = _platform.api2wire_String(serverOutput);
    var arg1 = _platform.api2wire_String(userKeys);
    var arg2 = api2wire_i32(keyCount);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_prepare_register_device(port_, arg0, arg1, arg2),
  ...
  Future<RegisterDeviceData> registerDevice(
    ...
    var arg4 = api2wire_i32(keyCount);
    var arg5 = _platform.api2wire_String(userKeys);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner
          .wire_register_device(port_, arg0, arg1, arg2, arg3, arg4, arg5),
  ...
  Future<void> userDeviceKeySessionUpload(
    ...
    var arg1 = _platform.api2wire_String(authToken);
    var arg2 = _platform.api2wire_String(jwt);
    var arg3 = _platform.api2wire_String(sessionId);
    var arg4 = _platform.api2wire_String(userPublicKey);
    var arg5 = _platform.api2wire_String(groupKeys);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_user_device_key_session_upload(
  ...
  Future<UserKeyData> doneFetchUserKey(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_done_fetch_user_key(port_, arg0, arg1),
  ...
  Future<UserKeyData> fetchUserKey(
    ...
    var arg4 = _platform.api2wire_String(privateKey);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner
          .wire_fetch_user_key(port_, arg0, arg1, arg2, arg3, arg4),
      parseSuccessData: _wire2api_user_key_data,
  ...
  Future<void> resetPassword(
    ...
    var arg1 = _platform.api2wire_String(authToken);
    var arg2 = _platform.api2wire_String(jwt);
    var arg3 = _platform.api2wire_String(newPassword);
    var arg4 = _platform.api2wire_String(decryptedPrivateKey);
    var arg5 = _platform.api2wire_String(decryptedSignKey);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner
          .wire_reset_password(port_, arg0, arg1, arg2, arg3, arg4, arg5),
      parseSuccessData: _wire2api_unit,
  ...
  Future<UserPublicKeyData> userFetchPublicKey(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_user_fetch_public_key(port_, arg0, arg1, arg2),
  ...
  Future<String> userFetchVerifyKey(
    ...
    var arg1 = _platform.api2wire_String(authToken);
    var arg2 = _platform.api2wire_String(userId);
    var arg3 = _platform.api2wire_String(verifyKeyId);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner
          .wire_user_fetch_verify_key(port_, arg0, arg1, arg2, arg3),
      parseSuccessData: _wire2api_String,
  ...
  Future<String> userKeyRotation(
    ...
    var arg1 = _platform.api2wire_String(authToken);
    var arg2 = _platform.api2wire_String(jwt);
    var arg3 = _platform.api2wire_String(publicDeviceKey);
    var arg4 = _platform.api2wire_String(preUserKey);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner
          .wire_user_key_rotation(port_, arg0, arg1, arg2, arg3, arg4),
      parseSuccessData: _wire2api_String,
  ...
  Future<List<KeyRotationGetOut>> userPreDoneKeyRotation(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner
          .wire_user_pre_done_key_rotation(port_, arg0, arg1, arg2),
  ...
  Future<KeyRotationInput> userGetDoneKeyRotationServerInput(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner
          .wire_user_get_done_key_rotation_server_input(port_, arg0),
  ...
  Future<void> userFinishKeyRotation(
    ...
    var arg2 = _platform.api2wire_String(jwt);
    var arg3 = _platform.api2wire_String(serverOutput);
    var arg4 = _platform.api2wire_String(preGroupKey);
    var arg5 = _platform.api2wire_String(publicKey);
    var arg6 = _platform.api2wire_String(privateKey);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_user_finish_key_rotation(
  ...
  Future<List<GroupOutDataKeys>> groupExtractGroupKeys(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_group_extract_group_keys(port_, arg0),
  ...
  Future<String> groupDecryptHmacKey(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_group_decrypt_hmac_key(port_, arg0, arg1),
      parseSuccessData: _wire2api_String,
  ...
  Future<String> groupPrepareKeyRotation(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_group_prepare_key_rotation(port_, arg0, arg1),
      parseSuccessData: _wire2api_String,
  ...
  Future<KeyRotationInput> groupGetDoneKeyRotationServerInput(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner
          .wire_group_get_done_key_rotation_server_input(port_, arg0),
      parseSuccessData: _wire2api_key_rotation_input,
  ...
  Future<void> groupFinishKeyRotation(
    ...
    var arg2 = _platform.api2wire_String(jwt);
    var arg3 = _platform.api2wire_String(id);
    var arg4 = _platform.api2wire_String(serverOutput);
    var arg5 = _platform.api2wire_String(preGroupKey);
  ...
  Future<UserPublicKeyData> groupGetPublicKeyData(
    ...
    var arg0 = _platform.api2wire_String(baseUrl);
    var arg1 = _platform.api2wire_String(authToken);
    var arg2 = _platform.api2wire_String(id);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner
  ...
  Future<EncryptedHead> splitHeadAndEncryptedData(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_split_head_and_encrypted_data(port_, arg0),
  ...
  Future<EncryptedHead> splitHeadAndEncryptedString(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_split_head_and_encrypted_string(port_, arg0),
      parseSuccessData: _wire2api_encrypted_head,
  ...
  Future<EncryptedHead> deserializeHeadFromString(
      {required String head, dynamic hint}) {
    var arg0 = _platform.api2wire_String(head);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_deserialize_head_from_string(port_, arg0),
      parseSuccessData: _wire2api_encrypted_head,
  ...
  Future<NonRegisteredKeyOutput> generateNonRegisterSymKey(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_generate_non_register_sym_key(port_, arg0),
  ...
  Future<NonRegisteredKeyOutput> generateNonRegisterSymKeyByPublicKey(
      {required String replyPublicKey, dynamic hint}) {
    var arg0 = _platform.api2wire_String(replyPublicKey);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner
          .wire_generate_non_register_sym_key_by_public_key(port_, arg0),
      parseSuccessData: _wire2api_non_registered_key_output,
  ...
  Future<String> decryptSymKey(
      ...
      dynamic hint}) {
    var arg0 = _platform.api2wire_String(masterKey);
    var arg1 = _platform.api2wire_String(encryptedSymmetricKeyInfo);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_decrypt_sym_key(port_, arg0, arg1),
      parseSuccessData: _wire2api_String,
  ...
  Future<String> decryptSymKeyByPrivateKey(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner
          .wire_decrypt_sym_key_by_private_key(port_, arg0, arg1),
      parseSuccessData: _wire2api_String,
  ...
  Future<List<FilePartListItem>> fileDownloadPartList(
    ...
    var arg0 = _platform.api2wire_String(baseUrl);
    var arg1 = _platform.api2wire_String(authToken);
    var arg2 = _platform.api2wire_String(fileId);
    var arg3 = _platform.api2wire_String(lastSequence);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner
          .wire_file_download_part_list(port_, arg0, arg1, arg2, arg3),
  ...
  Future<FileDoneRegister> fileDoneRegisterFile(
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_file_done_register_file(port_, arg0),
...
// Section: wire2api
  ...
  GroupOutDataHmacKeys _wire2api_group_out_data_hmac_keys(dynamic raw) {
    final arr = raw as List<dynamic>;
    if (arr.length != 2)
      throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
  ...
  List<GroupOutDataHmacKeys> _wire2api_list_group_out_data_hmac_keys(
      dynamic raw) {
    return (raw as List<dynamic>)
        .map(_wire2api_group_out_data_hmac_keys)
        .toList();
  }
  ...
  UserData _wire2api_user_data(dynamic raw) {
    ...
    return UserData(
      ...
      hmacKeys: _wire2api_list_group_out_data_hmac_keys(arr[6]),
    );
  }
...
class SentcFlutterPlatform extends FlutterRustBridgeBase<SentcFlutterWire> {
  SentcFlutterPlatform(ffi.DynamicLibrary dylib)
      : super(SentcFlutterWire(dylib));
